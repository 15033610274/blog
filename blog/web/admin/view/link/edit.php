                ...
                <div class="am-g" style="padding: 0 20px">
                    <form action="" class="form-horizontal" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="input-group" style="margin-top:5px;">
                                    <img src="{{$oldData['logo']}}" class="img-responsive img-thumbnail haibao" width="150">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="url" id="url" class="form-control" placeholder="链接地址" value="{{$oldData['url']}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="#sort" class="col-sm-2 control-label">链接排名</label>
                            <div class="col-sm-9">
                                <input type="text" name="sort" id="sort" class="form-control" value="{{$oldData['sort']}}" placeholder="链接排名">
                            </div>
                        </div>
                        <div class="form-group" style="padding: 0 20px;">
                            <input type="submit" class="btn btn-primary btn-block submit" id="" value="提交">
                        </div>
                        <input type="hidden" name="lid" value="{{q('get.lid','0','intval')}}">
                    </form>
                </div>
            </div>
