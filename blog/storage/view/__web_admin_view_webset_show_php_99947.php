            ...
            <div class="admin-content-body">
                ...
                <div class="am-g" style="padding: 0 20px">
                    <form action="" method="post">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php foreach ((array)$oldData as $key=>$value){?>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="value[]" value="<?php echo $value['value']?>" placeholder="请输入配置值">
                                            </td>
                        ...
                        <input type="hidden" name="__TOKEN__" value="5d1030b3b265acce00112b738c640dd3"><input type='hidden' name='__TOKEN__' value='fe2eac2aa324a8887b07a2bcac352d1a'/></form>
                </div>
            </div>
...
<script>
    $(function(){
        $('.submit').click(function () {
            ...
            $.post("<?php echo u('show')?>",data,function (res) {
                if(res.valid){
