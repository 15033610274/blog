                ...
                <div class="am-g">
                    <div class="am-u-sm-12">
                        <form class="am-form" action="" method="post">
                                ...
                                <?php foreach ((array)$oldData as $key=>$value){?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="am-btn-toolbar">
                                                <div class="am-btn-group am-btn-group-xs">
                                                    <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="edit(<?php echo $value['aid']?>)"><span class="am-icon-pencil-square-o"></span> 编辑</button>
                                                    <button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="del(<?php echo $value['aid']?>)"><span class="am-icon-trash-o"></span> 删除</button>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <hr>
                            <p>注：.....</p>
                        <input type='hidden' name='__TOKEN__' value='4ce6715361f260d233e956e34d61c875'/></form>
                    </div>
...
<script>
            ...
            var obj = util.modal({
                ...
                events:{
                    confirm:function(){
                        ...
                        location.href = "<?php echo u(del)?>" + "&aid=" + aid;
                    }
                }
            });
            //显示模态框
    ...
    function edit(aid) {
        window.location.href = "<?php echo u(edit)?>" + '&aid=' + aid;
    }
    $(function(){
