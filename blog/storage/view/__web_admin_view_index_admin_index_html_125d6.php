                ...
                <ul class="am-list admin-sidebar-list">
                    ...
                    <li class="admin-parent">
                        <a class="am-cf" data-am-collapse="{target: '#collapse-nav'}">
                            <span class="am-icon-file"></span> 课程管理 <span class="am-icon-angle-right am-fr am-margin-right"></span>
                        </a>
                        <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
                            <li><a href="<?php echo u(adminUser)?>" class="am-cf"><span class="am-icon-check"></span> 阶段课程<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
                            <li><a href="<?php echo u(admin404)?>"><span class="am-icon-bug"></span> 碎片课程</a></li>
                        </ul>
                    </li>
            ...
            <div class="am-panel am-panel-default">
              ...
              <div id="collapse-panel-2" class="am-in">
                <table class="am-table am-table-bd am-table-bdrs am-table-striped am-table-hover">
                  ...
                  <tr>
                    <td class="am-text-center"><img src="<?php echo __ROOT__?>/web/admin/view/index/assets/i/examples/admin-chrome.png" alt=""></td>
                    <td>Google Chrome</td>
                    <td>3,005</td>
                  </tr>
                  <tr>
                    <td class="am-text-center"><img src="<?php echo __ROOT__?>/web/admin/view/index/assets/i/examples/admin-firefox.png" alt=""></td>
                    <td>Mozilla Firefox</td>
                    <td>2,505</td>
                  </tr>
                  <tr>
                    <td class="am-text-center"><img src="<?php echo __ROOT__?>/web/admin/view/index/assets/i/examples/admin-ie.png" alt=""></td>
                    <td>Internet Explorer</td>
                    <td>1,405</td>
                  </tr>
                  <tr>
                    <td class="am-text-center"><img src="<?php echo __ROOT__?>/web/admin/view/index/assets/i/examples/admin-opera.png" alt=""></td>
                    <td>Opera</td>
                    <td>4,005</td>
                  </tr>
                  <tr>
                    <td class="am-text-center"><img src="<?php echo __ROOT__?>/web/admin/view/index/assets/i/examples/admin-safari.png" alt=""></td>
                    <td>Safari</td>
                    <td>505</td>
                  </tr>
                  </tbody>
