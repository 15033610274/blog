        ...
        <div class="admin-content">
            <div class="admin-content-body">
                <div class="am-cf am-padding am-padding-bottom-0">
                    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">分类管理</strong> / <small>addSon</small></div>
                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="ctitle" class="form-control" placeholder="分类标题">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">分类描述</label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="cdes" placeholder="分类描述"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">分类关键字</label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="ckeywords" placeholder="分类关键字"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">分类排序</label>
                                    <div class="col-sm-9">
                                        <input type="number" name="csort" class="form-control" placeholder="分类排序">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <button class="btn btn-primary btn-block submit" type="submit">确定</button>
                    <input type='hidden' name='__TOKEN__' value='7817a2ae4dfbb25cb8acb2abf66086d9'/></form>
                </div>
            </div>
