                        ...
                        <div class="panel panel-default" style="border: 0;">
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" value="<?php echo $oldData['title']?>" name="title" class="form-control" placeholder="文章标题">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="js-example-basic-single form-control" name="category_cid">
                                            ...
                                            <?php foreach ((array)$cateData as $key=>$value){?>
                                                <option value="<?php echo $value['cid']?>" <?php if($value['cid']==$oldData['category_cid']){?>
                selected
               <?php }?> ><?php echo $value['_cname']?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <?php foreach ((array)$tagData as $key=>$value){?>
                                            <?php foreach ((array)$oldData['tid'] as $k=>$v){?>
                                                <label class="checkbox-inline">
                                                        <input type="checkbox" name="tag_tid[]" value="<?php echo $value['tid']?>" <?php if($v==$value['tid']){?>
                checked
               <?php }?> > <?php echo $value['tname']?>
                                                </label>
                                            <?php }?>
                                        <?php }?>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="input-group" style="margin-top:5px;">
                                            <img src="<?php echo $oldData['thumb']?>" class="img-responsive img-thumbnail haibao" width="150">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="content" class="form-control" placeholder="文章内容"><?php echo $oldData['content']?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <input type="hidden" name="aid" value="<?php echo q('get.aid','0','intval')?>">
