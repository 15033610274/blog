        ...
        <div class="row">
            <div class="col-sm-12" >
                ...
                <div class="collapse navbar-collapse" id="example-navbar-collapse">
                    <ul class="_menu" >
                        <li class="_active"  ><a href="http://c70_yangyuhui.houdunphp.com/hdphp">首页</a></li>
...
<section>
		...
		<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img src="<?php echo __ROOT__?>/web/home/view/public/images/1.jpg">
				</div>
				<div class="item">
					<img src="<?php echo __ROOT__?>/web/home/view/public/images/2.jpg">
				</div>
			</div>
	...
	<?php foreach ((array)$arcs as $key=>$value){?>
		<article>
			<div class="_head">
			...
			<div class="_digest">
				<img src="<?php echo __ROOT__?>/<?php echo $value['thumb']?>"  class="img-responsive"/>
				<p>
					<?php echo $value['digest']?>
				</p>
			</div>
			<div class="_more">
				<a href="<?php echo u('content/index',array('aid'=>$value['aid']))?>" class="btn btn-default">阅读全文</a>
			</div>
			<div class="_footer">
				<i class="glyphicon glyphicon-tags"></i>
				<?php foreach ((array)$value['tags'] as $k=>$v){?>
					<a href="<?php echo u('listpage/index',array('tid'=>$v['tid']))?>"><?php echo $v['tname']?></a>、
				<?php }?>
			</div>
		</article>
	<?php }?>
            ...
            <aside class="col-md-4 hidden-sm hidden-xs">
                ...
                <div class="_widget">
                    ...
                    <div>
                                                    ...
                                                    <a style="margin: 10px 0;padding:7px 7px;transition: all 1s ease 0s;" href="http://c70_yangyuhui.houdunphp.com/hdphp/index.php?s=home/listpage/index&cid=6">伤感文章 (2)</a>
            ...
            <div class="col-sm-4">
                <h4 class="_title">最新文章</h4>
                        ...
                        <time>16-09-13 18:30:38</time>
                                    ...
                                    <div id="" class="_single">
                        <p><a href="http://c70_yangyuhui.houdunphp.com/hdphp/index.php?s=home/content/index&aid=5">每人的生命里都有一只碗</a></p>
                        <time>16-09-12 21:50:02</time>
                    </div>
                            </div>
