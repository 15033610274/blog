                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="ctitle" value="<?php echo $oldData['ctitle']?>" class="form-control" placeholder="分类标题">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">分类描述</label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="cdes" placeholder="分类描述"><?php echo $oldData['cdes']?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">分类关键字</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="ckeywords" placeholder="分类关键字" value="<?php echo $oldData['cname']?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">分类排序</label>
                                    <div class="col-sm-9">
                                        <input type="number" name="csort" class="form-control" value="<?php echo $oldData['csort']?>" placeholder="分类排序">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <input type="hidden" name="cid" value="<?php echo q('get.cid',0,'intval')?>">
                        <button class="btn btn-primary btn-block submit" type="submit">确定</button>
                    <input type='hidden' name='__TOKEN__' value='30de42134d4c4ac20286ea888a1fd1e7'/></form>
                </div>
            </div>
