        ...
        <div class="admin-content">
            <div class="admin-content-body">
                <div class="am-cf am-padding am-padding-bottom-0">
                    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">分类管理</strong> / <small>add</small></div>
                </div>
                ...
                <div class="am-g" style="padding: 0 20px">
                    <form class="form-horizontal" id="form" action="" method="post" onsubmit="return add()">
                        ...
                        <input type='hidden' name='__TOKEN__' value='4a2f1ec7dbce7eba6685e9772d5ef8b9'/></form>
                </div>
            </div>
